...
The purpose of this project is to perform image translation between summer and winter pictures using CycleGAN and also to perform semantic segmentation using UNet. The image data was obtained from Kaggle. 

CycleGAN architecture: <img width="914" alt="Screen Shot 2022-07-26 at 11 04 14 PM" src="https://user-images.githubusercontent.com/72672367/181151750-48904095-800f-4f8b-8078-73856b478ac0.png">
...
The second part of the project is to perform semantic segmentation using UNet model. The image data was also obtained from Kaggle and it has lables from nine different class keys. 
